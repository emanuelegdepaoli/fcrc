...
InfectList <- c("A001", "A002", "A003", "A004", "A005", "A006", "A007", "A008", "A009", "A010", "A011", "A012","A013", "A014", "A015", "A016", "A017", "A018", "A019", "A020", "A021", "A022", "A023", "A024", "A025", "A026", "A027", "A028","A029", "A030", "A031", "A032", "A033", "A034", "A035", "A036", "A037", "A038", "A039", "A040", "A041", "A042", "A043", "A104","B001", "B002", "B003", "B004", "B005","B006", "B007", "B008", "B009", "B010", "B011", "B012", "B013", "B014", "B015", "B016", "B017")
NeopList <- c("A044","A045", "A046", "A047", "A048", "A049","A051", "A052", "A053", "A054", "A055", "A056", "A057", "A058", "A059", "A060","B018","B019")
LungList <- c("A050")
EndocList <- c("A061","A061", "A062", "A063", "A064","A065","A066","B020","B021")
MentalList <- c("A067","A068","A069","A136","B045")
NervList <- c("A071","A072","A073","A074","A075","A076","A077","A078")
...
DigestList <- c("A098", "A099", "A100", "A101", "A102", "A103", "A104", "A105", "A106", "A107","B033", "B034", "B035", "B036", "B037", "B038")
UroList <- c("A108","A109","A110","A111","A112","A113","A114","B039")
SkinList <- c("A121","A122","A123","A124","A125","A126")
CongeList <- c("A127","A128","A129", "A130","B041")
InfantList <- c("A115","A116","A117","A118","A119","A120","A131","A132","A133","A134","A135","B040","B042","B043","B044")
ExternList <- c("A138", "A139", "A140","A141", "A142", "A143", "A144", "A145", "A146", "A147", "A148", "A149", "A150","B047", "B048", "B049", "B050")
OthList <- c("A137","B046")
##A065, B021 Anaemias ->Endoc
##A066 Allergic disorders; all other endocrine, metabolic, and blood diseases ->Endoc
##A067-A068  Psychoses - Psychoneuroses and disorders of personality ->Mental
##A069 Mental deficiency->Mental
##A071-A078 diseases of the nervous system and sense organs - Nervous
##A108-A109, B038 nephritis -> Uro
##A110 Infections of kidney -> Uro
##A111-A114,B039 diseases of genito-urinary system -> Uro
##A115-A117,B040 problems related to pregnancy and the puerperium -> Infant
##A118-A119 Abortion
##A120 Other complications of pregnancy, childbirth, and the puerperium.
##A121 Infections of skin and subcutaneous tissue -> Skin
##A122-A126 All other diseases of skin and musculoskeletal system -> Skin
##A127 Spina bifida and meningocele -> Congenital
##A128-A130,B041 All other congenital malformations -> Congenital
##A131-A135,B042-B044 Birth injuries, Postnatal asphyxia and atelectasis, Infections of the newborn, Haemolytic disease of the newborn, All other defined diseases of early infancy
##A136, B045 Senility without mention of psychosis -> Mental
...
ICD7$CauseM <- ifelse(ICD7$Cause%in%MentalList, 9,ICD7$CauseM)
ICD7$CauseM <- ifelse(ICD7$Cause%in%NervList, 10,ICD7$CauseM)
ICD7$CauseM <- ifelse(ICD7$Cause%in%UroList, 11,ICD7$CauseM)
ICD7$CauseM <- ifelse(ICD7$Cause%in%SkinList, 12,ICD7$CauseM)
ICD7$CauseM <- ifelse(ICD7$Cause%in%CongeList, 13,ICD7$CauseM)
ICD7$CauseM <- ifelse(ICD7$Cause%in%InfantList, 14,ICD7$CauseM)
ICD7$CauseM <- ifelse(ICD7$Cause%in%OthList, 15,ICD7$CauseM)
...
write.csv(complete,file="ICD7_comp_new.csv",sep=",")        
