...
MentalList <- c(levels(ICD10$Cause)[(substr(levels(ICD10$Cause),1,1)=="F")], "CH05","R40",  "R400", "R401","R402","R41","R410","R411","R413","R418","R45","R450","R451","R453","R454","R456","R457","R458","R46",  "R460", "R461", "R463", "R468","R54")
...
InfantList <- c(levels(ICD10$Cause)[(substr(levels(ICD10$Cause),1,1)=="O")],levels(ICD10$Cause)[(substr(levels(ICD10$Cause),1,1)=="P")], "CH15","CH16")
...
write.csv(complete,file="ICD10_comp_new.csv",sep=",")        
